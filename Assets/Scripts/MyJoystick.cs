...
{
    public Camera arCam;
    public Rigidbody remoteControlPoint;
            ...
            if (Input.touches.Length > 0 ){
                foreach (Touch touch in Input.touches){
                    ...
                    if (Physics.Raycast(ray, out hit)){
                        ...
                        if (usingJoystick && hit.collider.CompareTag("Joystick")){
    ...
    void MovePlayer(Vector3 direction){
        ...
        remoteControlPoint.MovePosition(remoteControlPoint.transform.position + movement);
